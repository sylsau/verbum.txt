  ...
  Ce document expose des conventions de formatage de texte en prose, selon une 
esthétique à la fois élégante et lisible.
...
versatile. Il faut avouer que c'est extrêmement facile de justifier des textes 
littéraires avec nano ; deux simples pressions simultanées sur CTRL et J font 
l'affaire !

    Ceci est un paragraphe verbatim. Un retrait de 4 espaces sur chaque ligne 
    le caractérise. Pour l'écrire puis le justifier facilement avec nano, il 
    suffit d'activer la fonction "retrait automatique" (M-I).

- Pour ce qui est des listes ;
- On comprend vite que leur lecture ;
- Serait encombrée par un retrait ;
